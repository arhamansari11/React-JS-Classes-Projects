          ...
          <div className="col-10 mx-auto d-flex">
            <div className="col-lg-6 col-md-6 col-sm-6 col-6 text mt-lg-5">
              ...
              <h6 className="info">
                ...
                Perferendis minus impedit soluta mollitia eos saepe esse,
                reiciendis iusto unde, sunt sed. Ullam ratione recusandae
                veritatis veniam tenetur natus ad nobis.
              </h6>
              <h5
                style={{ color: "#33839C", cursor: "pointer" }}
                className="info"
              >
                Are You want more information?
              </h5>
              <button className="button1 mt-lg-3 mt-md-4 mt-sm-4 mt-1">
                <h5 className="text2">Motivational is here</h5>
              </button>
            </div>
